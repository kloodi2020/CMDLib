...
if network_is_server() or network_is_moderator() then
    makeCommand("tp", {
        ...
        longDescription = "Teleport to another player",
        arguments = {argumentFrom("playerTo", _G.CMDLib.ARG_TYPE_PLAYER_SINGLE, _G.CMDLib.ARG_PARAM_REQUIRED)},
        callback = function(args)
            local playerTo = args.playerTo

            warp_to_level(playerTo.currLevelNum, playerTo.currAreaIndex, playerTo.currActNum)
        end
    })
end
